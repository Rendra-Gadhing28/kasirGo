...
func main() {
	...
	// 3. Run Seeder (safe: checks if outlet count == 0)
	...
	// Public Auth Routes (With Auth Rate Limiter)
	...
	// Public Member & Outlet Routes (No Auth Required)
	...
	// Protected Routes (JWT Required + Tenant Isolation + General Rate Limiter)
